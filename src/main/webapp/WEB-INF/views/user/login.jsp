...
<head>
<meta charset="UTF-8">
<title>Login Harlex PEPE Diamond Boys</title>
<link rel="stylesheet"
                    ...
                    <div class="authfy-login">
                         <div class="authfy-panel panel-login text-center active">
                            <div class="authfy-heading">
                                ...
                                <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup" href="/user/signup">Sign Up Free!</a></p>
                                 <p style="color: red" >${message}${param.error}</p>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <form name="loginForm" class="loginForm" action="/user/login" method="POST">
                                ...
                                <span class="label-text">Remember me</span>
                                            ...
                                            <div class="col-xs-6 col-sm-6">
                                                <p class="forgotPwd">
                                                    <a class="lnk-toggler" data-panel=".panel-forgot" href="/user/forgot">Forgot password?</a>
                                                </p>
                                            </div>
                                        </div>
                                        <!-- ./remember-row -->
