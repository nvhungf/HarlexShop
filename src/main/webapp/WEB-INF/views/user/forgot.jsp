...
<head>
<meta charset="UTF-8">
<title>Forgot Password Harlex PEPE Diamond Boys</title>
<link rel="stylesheet"
		...
		<div class="row">
			<div
				...
				<div class="col-sm-5 ">
					...
					<img id="image-1" alt="" src="../../../img/forgot.jpg"
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12">
									<div class="authfy-heading">
										...
										<p>Fill in your e-mail address below and we will send you
											an email with further instructions.</p>
										<p>${message}</p>
									</div>
									<form name="forgetForm" class="forgetForm"
										action="/user/send.html" method="post">
										<div class="form-group">
											<input type="email" class="form-control" name="to"
												placeholder="Email address">
										</div>
										<div class="form-group">
											<button class="btn btn-lg btn-primary btn-block">Recover
										...
										<div class="form-group">
											<a class="lnk-toggler" data-panel=".panel-signup"
												href="/user/signup">Don’t have an account?</a>
										</div>
									</form>
								</div>
							</div>
