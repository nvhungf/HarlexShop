...
<head>
<meta charset="UTF-8">
<title>Sign Up Harlex PEPE Diamond Boys</title>
<link rel="stylesheet"
	href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
	integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T"
	crossorigin="anonymous">
<link rel="stylesheet"
	href="https://ghcdn.rawgit.org/nvhungf/User/main/loginstyle.css" />
</head>
<body>
	<div class="dust-paarticle">
        ...
        <path
				...
				stroke-linecap="round" stroke-linejoin="round" />
        <path d="M768.2 366.7H775.5" stroke="#9E3FB7" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M771.8 363.1V370.4" stroke="#9E3FB7" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <g opacity="0.6">
        <path opacity="0.6" d="M696.4 40.5H703.8" stroke="#9E3FB7"
				stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path opacity="0.6" d="M700.1 36.8V44.2" stroke="#9E3FB7"
				stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        </g>
        <path d="M630.3 284.1H636" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M633.2 281.2V286.9" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M414.9 104.5H420.6" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M417.8 101.7V107.3" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M203.7 290.8H211.5" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M207.6 286.9V294.6" stroke="#E03F8D" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M165.9 402.7H176.2" stroke="#1DB7C2" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path d="M171 397.5V407.9" stroke="#1DB7C2" stroke-width="2"
				stroke-miterlimit="10" stroke-linecap="round"
				stroke-linejoin="round" />
        <path
		...
		<div class="row">
			<div
				...
				<div class="col-sm-5 ">
						...
						<img id="image-1" alt="" src="../../../img/reg.jpg" width="300px" height="460px""/>
								...
								<div class="col-xs-12 col-sm-12">
									...
									<form:form action="" modelAttribute="item">
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													<form:input name="fullname" type="text" path="fullname" class="form-control" 
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													<form:input name="phone" type="number" path="phone" class="form-control" 
														placeholder="Phone" />
												</div>
											</div>
											<div class="col-xs-6 col-sm-6">
												<div class="form-group">
													<form:input name="address"  type="location" path="address" class="form-control" 
														placeholder="Address" />
												</div>
											</div>
										</div>
										<div class="form-group">
											<p class="term-policy text-muted small">
												I agree to the <a href="#">privacy policy</a> and <a
													href="#">terms of service</a>.
											</p>
										</div>
										<div class="form-group">
											<button class="btn btn-lg btn-primary btn-block"
											  formaction="/user/reg"	type="submit">Sign up</button>
										</div>
									</form:form>
									<a class="lnk-toggler" data-panel=".panel-login"
										href="/user/login">Already have an account?</a>
								</div>
							</div>
						</div>
						<!-- ./panel-forgot -->
	...
	<div id="snell">
		...
		<svg width="100%" height="100" viewBox="0 0 328 265" fill="none"
        ...
        <path id="Vector_3"
				d="M45.7 128.6C40.6 128.2 35.5 127.8 30.4 127.4C33 107.8 31.8 88.1 27.2 69.3C30.8 68.3 34.4 67.2 38 66.1C44.4 85.9 47.1 107.1 45.7 128.6Z"
				stroke="#2A2A2A" stroke-width="6" stroke-miterlimit="10"
				stroke-linecap="round" stroke-linejoin="round" />
        </g>
             <g id="XMLID44">
        <g id="XMLID 49">
        ...
        <path id="XMLID 56"
				...
				stroke-linecap="round" stroke-linejoin="round" />
        <path id="XMLID 55"
				d="M45.3 158.8C45.6 159.1 50.4 163.7 51.7 168.5" stroke="#2A2A2A"
	...
	<script src="https://ghcdn.rawgit.org/nvhungf/User/main/loginjs.js"
